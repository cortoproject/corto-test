...
CORTO_TEST_EXPORT corto_bool _test_assert(corto_bool condition, corto_string str_condition, corto_uint32 __line);
#define test_assert(condition) _test_assert(condition, #condition, __LINE__)

CORTO_TEST_EXPORT corto_bool _test_assertEqual(corto_any a, corto_any b, corto_string str_a, corto_string str_b, corto_uint32 __line);
#define test_assertEqual(a, b) _test_assertEqual(a, b, #a, #b, __LINE__)

CORTO_TEST_EXPORT corto_void _test_fail(corto_string err);
